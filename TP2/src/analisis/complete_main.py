...
if __name__ == '__main__':
    ...
    for context in sys.argv:
        ...
        with open(f"{context}", "r") as file:
            ...
            for method in ["GEN_UNIFORM", "GEN_NON_UNIFORM", "MULTI_GEN_UNIFORM", "MULTI_GEN_NON_UNIFORM"]:
                id += 1
